...
export const signup = async (req,res)=>{
    ...
    try {
        ...
        try {
            ...
            console.log(`Error creating user in Stream for ${newUser.fullName}: ${error}`);
        }
...
export const onboard = async(req,res)=>{
    try {
       ...
       const updatedUser = await User.findByIdAndUpdate(
        userId,
        {
            ...req.body, //Spread operator for object
            isOnboarded:true,
        },
        { new: true });
    ...
    // upsert: sometimes create , sometimes update
    ...
    try {
        ...
        console.log(`Error upserting StreamUser during onboarding for ${updatedUser.fullName}: ${error}`);
    }
